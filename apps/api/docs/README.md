...
**Related (mobile package):**

- [`../mobile/docs/ARCHITECTURE.md`](../mobile/docs/ARCHITECTURE.md) — app navigation & modules
- [`../mobile/docs/DESIGN-SYSTEM.md`](../mobile/docs/DESIGN-SYSTEM.md) — v1 visual language
