...
> **Scope: Circuit v1 (minor release).** Same app (film‑production planning) — shipping a
> **limited‑functionality v1** with a **new visual language**. **Styling** comes from the
...
- [`../api/docs/PRODUCT.md`](../api/docs/PRODUCT.md) — v1 scope
- [`../api/docs/DATABASE.md`](../api/docs/DATABASE.md) — data model
- [`../api/docs/MIGRATION.md`](../api/docs/MIGRATION.md) — v1 scope & deferred features
- [`../../docs/ENVIRONMENT.md`](../../docs/ENVIRONMENT.md) — env workflows
